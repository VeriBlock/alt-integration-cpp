...
static const std::vector<TestCase> AwinsCases = {
    ...
    /**
     * Scenario: The same chains like in the previous case
     *
     * Expected: Chain A should be better than Chain B
     */
    {
        {{2000, 3},{2020, 4},{2040, 5},{2060, 6},{2080, 7},{2100, 8},{2120, 9}, {2140, 10}, {2160, 11}, {2180, 12}},
        {{2000, 1},{2020, 2},{2040, 3},{2060, 4},{2080, 5},{2100, 6},{2120, 7}, {2140, 8}, {2160, 9}, {2180, std::numeric_limits<int32_t>::max()}, {2200, 56}, {2220, 56}, {2240, 56}}
    },
