...
TEST_F(AltTreeTest, acceptBlock_test) {
  ...
  AltBlock block1;
  block1.hash = {1, 2, 5};
  block1.previousBlock = config_.getGenesisBlock().hash;
  block1.height = config_.getGenesisBlock().height + 1;
  block1.timestamp = 0;
  ...
  AltBlock block2;
  block2.hash = {2, 2, 2};
  block2.previousBlock = config_.getGenesisBlock().hash;
  block2.height = config_.getGenesisBlock().height + 1;
  block2.timestamp = 0;
