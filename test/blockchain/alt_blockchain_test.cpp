...
TEST_F(AltTreeFixture, invalidate_block_test1) {
  ...
  EXPECT_NE(containingBlockIndex1->getContext(endorsement1.id).getEndorsement(),
            nullptr);
  ...
  EXPECT_NE(containingBlockIndex2->getContext(endorsement2.id).getEndorsement(),
            nullptr);
  ...
  EXPECT_NE(containingBlockIndex3->getContext(endorsement3.id).getEndorsement(),
            nullptr);
