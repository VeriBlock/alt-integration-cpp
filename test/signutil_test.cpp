...
TEST(SIGN_UTIL, GenPubKey) {
  auto privateKey = VeriBlock::getPrivateKeyFromAsn1(defaultPrivateKeyAsn1);
  auto publicKey = VeriBlock::derivePublicKey(privateKey, false);
  auto publicKeyEncoded = VeriBlock::publicKeyUncompressedToAsn1(publicKey);
