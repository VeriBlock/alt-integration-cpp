...
[https://testnet.explore.veriblock.org/api/altchain/<altchain_Id>/validation/apm?withinNHours=4](https://testnet.explore.veriblock.org/api/altchain/<altchain_Id>/validation/apm?withinNHours=4)  
