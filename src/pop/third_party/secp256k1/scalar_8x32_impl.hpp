...
static void secp256k1_scalar_get_b32(unsigned char *bin, const secp256k1_scalar* a) {
    bin[0] = (unsigned char)(a->d[7] >> 24);
    bin[1] = (unsigned char)(a->d[7] >> 16);
    bin[2] = (unsigned char)(a->d[7] >> 8);
    bin[3] = (unsigned char)(a->d[7]);
    bin[4] = (unsigned char)(a->d[6] >> 24);
    bin[5] = (unsigned char)(a->d[6] >> 16);
    bin[6] = (unsigned char)(a->d[6] >> 8);
    bin[7] = (unsigned char)(a->d[6]);
    bin[8] = (unsigned char)(a->d[5] >> 24);
    bin[9] = (unsigned char)(a->d[5] >> 16);
    bin[10] = (unsigned char)(a->d[5] >> 8);
    bin[11] = (unsigned char)(a->d[5]);
    bin[12] = (unsigned char)(a->d[4] >> 24);
    bin[13] = (unsigned char)(a->d[4] >> 16);
    bin[14] = (unsigned char)(a->d[4] >> 8);
    bin[15] = (unsigned char)(a->d[4]);
    bin[16] = (unsigned char)(a->d[3] >> 24);
    bin[17] = (unsigned char)(a->d[3] >> 16);
    bin[18] = (unsigned char)(a->d[3] >> 8);
    bin[19] = (unsigned char)(a->d[3]);
    bin[20] = (unsigned char)(a->d[2] >> 24);
    bin[21] = (unsigned char)(a->d[2] >> 16);
    bin[22] = (unsigned char)(a->d[2] >> 8);
    bin[23] = (unsigned char)(a->d[2]);
    bin[24] = (unsigned char)(a->d[1] >> 24);
    bin[25] = (unsigned char)(a->d[1] >> 16);
    bin[26] = (unsigned char)(a->d[1] >> 8);
    bin[27] = (unsigned char)(a->d[1]);
...
static void secp256k1_scalar_negate(secp256k1_scalar *r, const secp256k1_scalar *a) {
    ...
    uint32_t dd = ~a->d[0];
    uint64_t t = (uint64_t)dd + SECP256K1_N_0 + 1;
    r->d[0] = t & nonzero; t >>= 32;
    dd = ~a->d[1];
    t += (uint64_t)dd + SECP256K1_N_1;
    r->d[1] = t & nonzero; t >>= 32;
    dd = ~a->d[2];
    t += (uint64_t)dd + SECP256K1_N_2;
    r->d[2] = t & nonzero; t >>= 32;
    dd = ~a->d[3];
    t += (uint64_t)dd + SECP256K1_N_3;
    r->d[3] = t & nonzero; t >>= 32;
    dd = ~a->d[4];
    t += (uint64_t)dd + SECP256K1_N_4;
    r->d[4] = t & nonzero; t >>= 32;
    dd = ~a->d[5];
    t += (uint64_t)dd + SECP256K1_N_5;
    r->d[5] = t & nonzero; t >>= 32;
    dd = ~a->d[6];
    t += (uint64_t)dd + SECP256K1_N_6;
