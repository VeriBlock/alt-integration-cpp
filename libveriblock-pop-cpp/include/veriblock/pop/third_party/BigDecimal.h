...
public:
    ...
    static std::string bcdiv(const std::string &lhs,
    ...
    static std::string bcadd(const std::string &lhs,
                             const std::string &rhs,
                             int scale = std::numeric_limits<int>::min());

    static std::string bcsub(const std::string &lhs,
                             const std::string &rhs,
                             int scale = std::numeric_limits<int>::min());

    static std::string bcmul(const std::string &lhs,
                             const std::string &rhs,
                             int scale = std::numeric_limits<int>::min());

    static std::string bcround(const std::string &lhs,
                               int scale = std::numeric_limits<int>::min());

    static int bccomp(const std::string &lhs,
                      const std::string &rhs,
                      int scale = std::numeric_limits<int>::min());
